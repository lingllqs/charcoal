_charcoal() {
    ...
    case "${cmd}" in
        charcoal)
            opts="-h -V --help --version query edit cache help"
            ...
            ;;
        charcoal__cache)
            opts="-h --help show clean import export help"
        ...
        charcoal__cache__export)
            ...
            return 0
            ;;
        charcoal__cache__help)
            opts="show clean import export help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        charcoal__help)
            ...
            return 0
            ;;
        charcoal__help__cache)
            opts="show clean import export"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        charcoal__query)
            ...
            case "${prev}" in
                --speak-as)
                    COMPREPLY=($(compgen -W "true false flip" -- "${cur}"))
                    return 0
                    ;;
                --concise-as)
                    COMPREPLY=($(compgen -W "true false flip" -- "${cur}"))
